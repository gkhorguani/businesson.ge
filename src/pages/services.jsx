...
const Services = () => {
    return (
        <div className="main-content">
                            ...
                            <div className="col-md-12 text-center">
                                ...
                                <nav role="navigation" className="breadcrumb-trail breadcrumbs">
                                    <div className="breadcrumbs">
                                        ...
                                        <span><i className="fa fa-angle-right"></i></span>
                                        <span className="trail-item trail-end text-theme-colored2">Service</span>
                                    </div>
                                </nav>
                            </div>
                        </div>
            ...
            <section className="bg-silver-light" data-tm-bg-img="images/bg/curve-bg-industryee2.png">
                                ...
                                <div className="tm-sc tm-sc-services services-style-current-theme mb-30">
                                    <div className="tm-service services type-services">
                                        ...
                                        <div className="details">
                                            ...
                                            <div className="btn-view-details"> <a href="#"
                                                className="btn btn-plain-text-with-arrow btn-sm"> View Details </a></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
